...
export const LAYERS: Layer[] = [
  ...
  { id: 'archBoxes', name: 'Wheel-arch boxes', defaultVisible: true, color: '#5fae6a', order: 3 },
  { id: 'floorPIR', name: 'Floor PIR', defaultVisible: false, color: '#d9c27a', order: 4 },
  { id: 'floorPly', name: 'Floor ply', defaultVisible: false, color: '#caa06a', order: 5 },
